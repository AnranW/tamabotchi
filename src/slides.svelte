		...
		<header>
			<div data-id="part-1" class="text-center h-[200px] w-[600px] place-content-center flex items-center rounded bg-orange-200">
				...
				<button on:click={ping} type="button" class="relative ml-auto flex-shrink-0 rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
					...
					<svg class="h-20 w-20" fill="none" viewBox="0 0 346.013 346.013" stroke-width="10" stroke="currentColor" aria-hidden="true">
				...
				<button type="button" class="relative ml-auto flex-shrink-0 rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
					...
					<span class="sr-only">View notifications</span>
					<a href="#diagnose">
						<svg class="h-20 w-20"fill="currentColor" viewBox="0 0 512 512">
						<g>
							<g>
		...
		<footer>
			<div data-id="part-1" class="text-center h-[200px] w-[600px] place-content-center flex items-center rounded bg-orange-200">
				...
				<button type="button" class="relative ml-auto flex-shrink-0 rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
					...
					<span class="sr-only">View notifications</span>
					<a href="#main">
					<svg class="h-20 w-20" fill="currentColor" viewBox="0 0 973.1 973.1" >
					<g>
